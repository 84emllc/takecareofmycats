...
### Added
- Simple Analytics integration with notrack parameter support

## [1.4.4] - 2026-01-01

### Fixed
- Move data-item-id attribute from div to checkbox input for proper localStorage save

## [1.4.3] - 2026-01-01

### Fixed
- Checkbox save state synchronization (ported from dogs site)
